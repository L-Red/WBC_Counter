...
from data_train import collate_fn, train, ResnetObjectDetectionDataset
import torch
import argparse
...
od_dataloader = DataLoader(od_dataset, collate_fn=None, batch_size=2)
...
train_dataloader = DataLoader(train_dataset, collate_fn=None, batch_size=2)
val_dataloader = DataLoader(val_dataset, collate_fn=None, batch_size=2)

# train model
train(model, optimizer, loss_fn, train_dataloader, val_dataloader, model_path=model_path, epochs=epochs, resnet=True)